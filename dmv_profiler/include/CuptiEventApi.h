...
public:
  ...
  CUdevice device() { return device_; }

  virtual CUpti_EventGroupSets *
  createGroupSets(std::vector<CUpti_EventID> &ids);
  ...
  virtual void readEvent(CUpti_EventGroup g, CUpti_EventID id,
